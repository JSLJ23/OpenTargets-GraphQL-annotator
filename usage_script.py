...
target_disease_association_results = main.annotate_target_disease_association(csv_file_2, "Ensembl_id", "Liver")
target_disease_association_results.to_csv('target_disease_associations.tsv', sep='\t', encoding='utf-8', index=False)

target_probe_association_results = main.annotate_target_chemical_probe_association(csv_file_2, "Ensembl_id")
